...
namespace PROYECT_SANTIAGO_MESA.Data.Reports
{
    public class SalesReportSmall
    {
        ...
        public byte[] CreateReport(SaleReportViewModel model)
        {
            ...
            _document = new iTextSharp.text.Document(new iTextSharp.text.Rectangle(200f, 440f));
        ...
        private void reportBody()
        {
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 6f, 0);
            _pdfPCell = new PdfPCell(new Phrase("Sales Invoice generated by : CalzadosCastell, contact : facebook.com/calzadoscastellperu ", _fontStyle));
            _pdfPCell.Colspan = _totalColumn;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
